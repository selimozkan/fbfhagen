...
(function ($) {
  ...
  $("[data-background]").each(function () {
    $(this).css({
      "background-color": "-webkit-gradient(linear, left bottom, left top, from(rgba(0, 0, 0, 0.9)), to(rgba(0, 0, 0, 0.9)))",
      "background-color": "linear-gradient(0deg, rgba(0, 0, 0, 0.9) 0%, rgba(0, 0, 0, 0.9) 100%)",
